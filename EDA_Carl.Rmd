...
hip_fracture_df = read_sav('../Data/HipFractureQualityData.sav') # This dir appears to work for both Carl and Bruno, if Rutwik can also use this dir it'll be much easier
```
...
```{r}
agg_df_srad30 <- setNames(aggregate(df2$SEX, by=list(df2$SEX,df2$RACE_NEW,df2$ReadmissionPost_119), FUN=length),
